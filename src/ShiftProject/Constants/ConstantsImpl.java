package ShiftProject.Constants;

public class ConstantsImpl {

    // Use in EngineImpl
    public static final String CURRENT_SHIFT_TODAY = "Current shift today:";
    public static final String PROGRAM_FINISHED_CORRECT = "The program finished succsefly!";
    public static final String SCHEDULE_RANGE = "Range of the schedule:";
